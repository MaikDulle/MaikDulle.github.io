...
![linear-assumption-Rplot](/img/posts/Linear-regression/linear-assumption-Rplot.png)<!-- -->
...
Note: The data distribution is quite focused on the middle and there seems to be little correlation between Score and PassAttempts. Therefore, interpret with caution.